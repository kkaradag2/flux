...
export function registerOrchestrationIpc(ipc: Pick<IpcMain, 'handle' | 'removeHandler' | 'on' | 'removeListener'>,
  ...
  for (const channel of [channels.followUp, channels.continueAttention, channels.get, channels.start, channels.continue, channels.create, channels.cancel, channels.execute, channels.cancelExecution, channels.retryExecution]) {
  ...
  return () => {
    ...
    for (const channel of [channels.followUp, channels.continueAttention, channels.get, channels.start, channels.continue, channels.create, channels.cancel, channels.execute, channels.cancelExecution, channels.retryExecution]) ipc.removeHandler(channel);
